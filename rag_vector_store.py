...
from utils_config_handler import chroma_conf
from langchain_text_splitters import RecursiveCharacterTextSplitter
from model_factory import embedding_model
from utils_file_handler import pdf_loader, text_loader, listdir_with_allowed_type, get_file_md5_hex
...
#                 创建文件
        ...
        allowed_files_path: list[str] = listdir_with_allowed_type(chroma_conf['data_path'],
                                                                  tuple(chroma_conf['allowed_file_type']), )
